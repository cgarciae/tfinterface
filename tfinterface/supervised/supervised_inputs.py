...
* `global_step : Variable` -
    ...
    def __init__(self, name, features, labels, dropout_keep_prob=0.5, **kwargs):
        ...
        super(SupervisedInputs, self).__init__(name, features=features, labels=labels, keep_prob=keep_prob_specs, training=training_specs, global_step=get_global_step, **kwargs)
